...
if the sentence "I need to go to the bank to make a deposit!" is fed to a unidirectional model reading from left:arrow_right:right, 
the representation of "bank" is determined based on "I need to go to the" but not "to make a deposit!":arrow_left:<span style="border-style: solid"><strong>The context</strong></span> 
There is a high chance for the right:arrow_right:left unidirectional models to make a similar misreading. BERT can solve this problem by 
...
In the above image, although ELMo seems to be bidirectional, it just merely learns the left:arrow_right:right & right:arrow_right:left context separately and concatenates both, 
...
<p align='center'><img src="https://miro.medium.com/max/875/0*ViwaI3Vvbnd-CJSQ.png" alt = 'masked language modelling' style="width: 50%;"></p>
